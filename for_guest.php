...
<body style="background-color:transparent">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8">
				<label style="color:#FFFFFF; font-family:Georgia, 'Times New Roman', Times, serif; font-weight:bold">Enter Guest Id : </label>
				<input type="text" name="gid" class="form-control" style="background-color:transparent; border:1px solid white; color:#FFFFFF" />
			</div>
			<div class="col-sm-4">
				<input type="submit" name="btn" value="Search Guest Detail" class="btn btn-danger pull-right" style="padding-left:40px; padding-right:40px; margin-top:20px" />
			</div>
		</div>
		</form>
...
<?php
	...
	if(isset($_POST['btn']))
	{
		...
		$sql="SELECT * FROM `alloat` WHERE `g_id`='$id'";
		...
		if($p==0)
		{
			?><span class="form-control" style="color:maroon; font-family:Georgia, 'Times New Roman', Times, serif; font-size:18px; font-weight:bold; margin-top:20px; width:800px; margin-left:100px">Guest Does Not Exist....</span><?php
		}
		else
		{
			...
			?>
				<div class="container" style="margin-top:20px; box-shadow:0px 8px 16px 0px rgba(0,0,0,.5); padding:10px; background:rgba(0,0,0,.3); border:1px solid white; border-radius:20px">
					<div class="row">
						<div class="col-sm-12" style="color:#FFFFFF; font-family:'Times New Roman', Times, serif; font-size:18px; text-align:center"><?php echo $result['guest_name'];  ?><hr /></div>
					...
					<div class="row">
						<div class="col-sm-6" style="color:#FFFFFF; font-family:'Times New Roman', Times, serif; font-weight:bold">
						Driver Name :
							<input type="text" value="<?php echo $result['dri_name'];  ?>" readonly="true" class="form-control" />
						</div>
						<div class="col-sm-6" style="color:#FFFFFF; font-family:'Times New Roman', Times, serif; font-weight:bold">
